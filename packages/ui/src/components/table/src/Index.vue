...
const _style = computed(() => {
  return {
    'height': props.data.length === 0 ? '100%' : '',
    '--hl-table-border-width': props.borderWidth,
    '--hl-table-border-color': props.borderColor,
  }
})
...
<template>
  <div :id="tableId" class="hl-table" :class="{ 'hl-table-border': border, 'nowrap': nowrap && !refresh_layout }" :style="_style">
