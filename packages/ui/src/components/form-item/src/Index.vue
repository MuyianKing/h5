...
<template>
  <van-field v-bind="$attrs" ref="field_ref" class="hl-form-item" :name="prop" :label="label" :rules="rules_comp" :model-value="modelValue" required="auto" :show-word-limit="showWordLimit" :label-width label-align="right">
