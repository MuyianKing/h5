<script setup>
import { Field, Icon as VanIcon } from 'vant'
...
<template>
  <div class="hl-input relative w-full">
    <field v-if="type === 'textarea'" type="textarea" class="input" :clearable="clearable" :disabled="disabled" :model-value="modelValue" :placeholder="placeHolder_str" rows="2" show-word-limit maxlength="50" @input="handleInput" />
    <template v-else>
