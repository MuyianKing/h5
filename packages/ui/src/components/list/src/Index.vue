...
import { Empty as VanEmpty, List as VanList, PullRefresh as VanPullRefresh, Skeleton as VanSkeleton } from 'vant'
...
<template>
  <van-pull-refresh ref="pull_ref" class="hl-list-wrapper" :model-value="pull_loading" @refresh="onLoad('pull')" @scroll="handleScroll">
